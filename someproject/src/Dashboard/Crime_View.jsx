...
// // import LawEnforcementDashboard from "../Components/Report"
...
//               <div className="p-2 bg-gray-300 rounded">Violent Crimes</div>
//               <div className="p-2 bg-gray-300 rounded">Property Crimes</div>
//               <div className="p-2 bg-gray-300 rounded">Cyber Crimes</div>
//           </Card>
//           <Card className="p-4 w-1/2">
